...
const HostEarnings = () => {
  ...
  const selectedVehicleEarnings = useSelector(
    (state) => state.vehicles[`${selectedVehicle}-earnings`]
  );
  ...
  return (
    <Box pt={20}>
      <Heading color="black">your earnings.</Heading>
        ...
        <Box p={20}>
          {selectedVehicle && selectedVehicleEarnings && (
            <Table variant="striped" colorScheme="blue" border="4px solid blue">
              <TableCaption>
                {hostVehicles[selectedVehicle].year}{" "}
                {hostVehicles[selectedVehicle].make}{" "}
                {hostVehicles[selectedVehicle].model}
              </TableCaption>
              <Thead>
                <Tr>
                  <Th>earnings</Th>
